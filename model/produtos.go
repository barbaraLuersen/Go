...
func BuscaTodosOsProdutos() []Produto {
	db := db.ConectaComBancoDeDados() //Abre a conexão com o banco de dados
...
func CriarNovoProduto(nome, descricao, preco string, quantidade int) {
...
func AtualizarProduto(id int, nome, descricao, preco string, quantidade int) {
	db := db.ConectaComBancoDeDados()
